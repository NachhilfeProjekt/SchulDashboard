...
const DashboardPage: React.FC = () => {
  ...
  // Personalisierte Begrüßungsnachricht basierend auf der Rolle
  let welcomeMessage = '';
  switch (user.role) {
    case 'developer':
      welcomeMessage = `Entwickler-Dashboard`;
      break;
    case 'lead':
      welcomeMessage = `Leitungs-Dashboard`;
      break;
    case 'office':
      welcomeMessage = `Büro-Dashboard`;
      break;
    case 'teacher':
      welcomeMessage = `Lehrer-Dashboard`;
      break;
    default:
    ...
    <Box sx={{ p: 3 }}>
      <Paper sx={{ p: 3, mb: 4 }}>
        ...
        <Typography variant="h6" gutterBottom>
          {welcomeMessage} - Standort: {currentLocation.name}
        </Typography>
      </Paper>
